...
const MODULE_KEYS = [
  ...
  { id: "quotations", label: "Quotations & Estimates", desc: "Create, view, edit client price quotations, manage validity and convert to sales." },
  { id: "sales", label: "Sales & GST Invoices", desc: "Create sales, returns, and print GST invoices in A4, A5, and Thermal layouts." },
  { id: "challans", label: "Delivery Challans", desc: "Dispatch inventory goods, generate transport passes, and track physical shipments." },
